...
public:
    Meeting(const int hours, const int minutes, const int days, const int months, const int years,
...
public:
    Task(const int hours, const int minutes, const int days, const int months, const int years,
         const std::string status);
...
public:
    Reminder(const int hours, const int minutes, const int days, const int months, const int years,
