...
Meeting::Meeting(const int hours, const int minutes, const int days, const int months, const int years,
                 const std::string status) : Day(hours, minutes, days, months, years) {
    uid = count;
    this->status = status;
}
...
Task::Task(const int hours, const int minutes, const int days, const int months, const int years,
           const std::string status) : Day(hours, minutes, days, months, years) {
    uid = count;
    this->status = status;
    if (status == "Completed")
...
Reminder::Reminder(const int hours, const int minutes, const int days, const int months, const int years,
                   const std::string message) : Day(hours, minutes, days, months, years) {
    uid = count;
